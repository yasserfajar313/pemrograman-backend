...
echo "<h1>Tugas</h1>";
echo "<p><strong>NIM:</strong> 0110223066</p>";
echo "<p><strong>Nama:</strong> Yasser Fajar P</p>";
echo "<p><strong>Prodi:</strong> Teknik Informatika</p>";
echo "<p><strong>Kelas:</strong> TI02</p>";
...
$animal = new Animal(['Lele', 'Ayam', 'Bebek', 'Kambing', 'Sapi']);
